...
//const char* ssid = "Hotspot-U320";
//const char* password = "kishan123";
...
void setup(void) {
  ...
  server.on("/update", handleRestart);
...
<tr>
 <td align="center" colspan="9"> TO CHANGE NOTIFICATION CLICK ON:<a href="/update"><button autofocus>UPDATE </button></a>
</tr>

...
lcd.begin();
  ...
  c_flag = true;
  pinMode(D6, INPUT);
  attachInterrupt(D6, isr1, FALLING);      //product
  pinMode(D7, INPUT_PULLUP);
  attachInterrupt(D7, isr2, FALLING);   //rpm
pinMode(D8, INPUT_PULLUP);
  attachInterrupt(D8, isr3, FALLING);   //rpm
...
// if(Serial.available()>0)
{
 ...
 Serial.println(data);
    ...
    if ((millis() - d_tim) > 5000)
    {
      ...
      Serial.println("(" + deviceId + "DSP" + distanceA + "R" + distanceB + "C" + distanceC + "V" + String(3.3) + "A" + String(0.5 ) + "I" + c_index + "T" + String(newtim()) + ")");
      client.print("(" + deviceId + "DSP" + distanceA + "R" + distanceB + "C" + distanceC + "V" + String(3.3) + "A" + String(0.5 ) + "I" + c_index + "T" + String(newtim()) + ")");

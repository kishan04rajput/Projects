...
LiquidCrystal lcd(14, 15, 16, 17, 18, 19);  //RS,EN,D7,D6,D5,D4
...
int i = 0, k = 0;
int  gps_status = 0;
String name = "<p>1. NAME OF DRIVER: JIGNESH DESAI </p>"; //22
//String dob = "<p>2. </p>";   //21
String number = "<p>4. Vehicle No.: XYZ</p>"; //29
...
void connect_wifi(String cmd, int t)
{
  ...
  while (1)
  {
    Serial.println(cmd);     //GPS
    Serial1.println(cmd); //WIFI
    while (Serial1.available() > 0)
    {
      if (Serial1.find("OK"))
      {
...
void Send()
{
  ...
  webpage = "<h1>WELCOME TO GPS BASED VEHICLE TRACING SYSTEM</h1><body bgcolor=f0f0f0>";
  webpage += name;
  //webpage += dob;
  webpage += number;
  webpage += cordinat;
